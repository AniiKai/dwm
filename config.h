...
static const char *lmmscmd[] =    {"lmms", NULL};
static const char *gimpcmd[] =    {"gimp", NULL};
static const char *electcmd[] =   {"electrum", NULL};
static const char *nuclcmd[] =    {"nuclear", NULL};
